        ...
        <v-container>
          ...
          <v-row>
            <v-col class="text-center">
              ...
              <v-btn depressed large color="primary" class="ml-4" disabled v-if="approvaldata.shop === 'N'">
                사업 신청 기간이 아닙니다
              </v-btn>
              <v-btn
                depressed
                ...
                color="primary"
                class="ml-4"
                to="applysocialwelfare2"
                v-if="approvaldata.shop === 'Y'"
              >
                사업 신청
              </v-btn>
            </v-col>
  ...
  methods: {
    init(){
      try{
        ...
        axios.get("/api/construction/getListTop3?type=2").then((response) => {
