        ...
        <v-container>
          ...
          <v-row>
            <v-col class="text-center">
              ...
              <v-btn depressed large color="primary" class="ml-4" disabled v-if="approvaldata.apartment === 'N'">
                사업 신청 기간이 아닙니다
              </v-btn>
              <v-btn
                depressed
                ...
                color="primary"
                class="ml-4"
                to="applysocialwelfare3"
                v-if="approvaldata.apartment === 'Y'"
              >
                사업 신청
              </v-btn>
            </v-col>
  ...
  methods: {
    init(){
      try{
        ...
        axios.get("/api/construction/getListTop3?type=3").then((response) => {
