                        ...
                        <v-row class="align-center">
                          ...
                          <v-col cols="12" sm="12" md="10">
                            <v-radio-group
                              ...
                              hide-details="auto"
                            >
                              <v-radio label="세대" value="single" @click="singleVisible = true;"></v-radio>
                              <v-radio label="단지" value="group" @click="singleVisible = false;"></v-radio>
                            </v-radio-group>
                          </v-col>
                        </v-row>
                      </div>
                        ...
                        <v-row class="align-center">
                          ...
                          <v-col>
                            <v-radio-group
                              ...
                              hide-details="auto"
                            >
                              <v-radio label="유" value="Y" @click="remoteVisible = true;"></v-radio>
                              <v-radio label="무" value="N" @click="remoteVisible = false;"></v-radio>
                            </v-radio-group>
                          </v-col>
                        </v-row>
                      </div>
